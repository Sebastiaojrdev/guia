...
1. **Fluxo dos atendimentos ambulatoriais eletivos do SUS:**  
...
2. **Fluxo nas unidades da FHEMIG.**  
...
3.	Procedimentos Ambulatoriais Contratualizados na FHEMIG
...
Todos os procedimentos realizados devem ser compatíveis com o SIGTAP, observar a exigências de cadastro no CNES de habilitação serviço e classificação para realizar e seguindo as regras de faturamento, respeitando os atributos de cada procedimento, comoquantidade máxima permitida por paciente, requisitos de complexidade do serviço prestado.
Procedimentos individualizados (BPA-I), necessitam de identificação nominal do paciente.
Procedimentos consolidados (BPA-C), utilizados para registros coletivos sem identificação nominal, quando aplicável.
...
3.1	Procedimentos com Finalidade Diagnóstica Grupo 02
...
3.1.2 (Subgrupo 02.02)Diagnóstico em Laboratório Clínico 
...
3.1.3 Subgrupo 02.03 - Diagnóstico por Imagem 
...
3.1.4Diagnóstico por Anatomia Patológica e Citopatologia 
...
3.2.2 Exames Anatomopatológicos: 
...
3.1.5 Subgrupo 02.04 - Testes Funcionais e Diagnóstico Especializado 
...
3.1.6 Subgrupo 02.05 – Diagnóstico por Ultrassonografia
...
3.1.7 Subgrupo 02.06 – Diagnóstico por Tomografia Computadorizada (TC) 
...
3.1.8  Subgrupo 02.07 – Diagnóstico por Ressonância Magnética (RM) 
...
3.1.10 Subgrupo 02.10 – Diagnóstico por Radiologia Intervencionista  
...
3.1.11 Subgrupo 02.11 – Diagnóstico Ginecologia-Obstetrícia
...
3.1.12 Subgrupo 02.11 – Forma de Organização 02.11.07 – Diagnóstico em Otorrinolaringologia e/ou Fonoaudiologia
...
3.1.13 Subgrupo 02.11 – Forma de Organização 02.11.08 – Diagnóstico em Pneumologia
...
4 - Procedimentos Clínicos Grupo 03
Procedimentos Clínicos abrange diversas formas de organização relacionadas à consulta médica, atendimento especializado, atenção domiciliar, urgências e outros serviços prestados aos pacientes. Abaixo, detalho as formas de organização com base nos procedimentos mencionados, conforme os códigos do Sigtap:

4.1 Consultas Médicas e/ou Outros Profissionais de Nível Superior
...
4.2 Forma de Organização 03.01.05 – Atenção Domiciliar
...
04.4 Forma de Organização 08 – Atendimento e/ou Acompanhamento Psicossocial
...
•	Irrigação Vesical – Código 03.01.10.011-0Irrigação da bexiga para tratar condições como infecções urinárias ou obstruções.
O procedimento Administração de Medicamentos na Atenção Especializada – código 03.01.10.001.2 – consiste no ato de administrar medicamentos por paciente, independentemente da quantidade de medicação administrada, prescritos nas consultas/atendimentos, incluindo as consultas/atendimentos realizadas no domicílio


04.5  Forma de Organização 03.01.07 – Atendimento e/ou Acompanhamento emReabilitação Física, Mental, Visual e Múltiplas Deficiências
...
•	Fonoaudiologia
•	Psicologia
•	Avaliação e adaptação de órteses e próteses - Público-alvo: Pacientes com deficiências temporárias ou permanentes, encaminhados por profissionais de saúde.
 Execução: Realizado por equipes multiprofissionais em unidades de reabilitação credenciadas pelo SUS.
4.6 Forma de Organização 10 – Atendimentos de Enfermagem (em geral)
...
4.7 Forma de Organização 11 – Atendimento e/ou Acompanhamento de Queimados
...
4.8	Forma de Organização 14 – Cuidados Paliativos
...
4.9	Forma de Organização 01 – Tratamento de Doenças Infecciosas e Parasitárias
...
4.10	Forma de Organização 08 – Tratamento de Doenças da Pele e do Tecido Subcutâneo
...
4.11	Forma de Organização 13 – Tratamento de Pacientes sob Cuidados Prolongados
...
4.12	Forma de Organização 18 – Tratamento HIV/AIDS
...
4.13	Forma de Organização 19 – Tratamento de Reabilitação
...
05 - Resumo do Faturamento Ambulatorial do SUS
